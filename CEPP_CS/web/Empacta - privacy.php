...
<head>
    ...
    <title>Privacy Policy | Filipino Cuisine</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
    <link rel="stylesheet" href="../Second attemp/styles.css">
</head>
<body>
    <?php
        include 'header.html';
    ...
    <div class="container mt-1 border border-light bg-light bg-gradient">
        <div class="text-center" style="height: 550px; padding: 100px 50px;">
